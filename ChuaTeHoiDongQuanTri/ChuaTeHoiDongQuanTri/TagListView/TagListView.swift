...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var tagListViewcornerRadius: CGFloat = 0 {
        didSet {
            tagViews.forEach {
    ...
    @IBInspectable open dynamic var tagListViewShadowColor: UIColor = .white {
        didSet {
            rearrangeViews()
        }
    }
    @IBInspectable open dynamic var tagListViewShadowRadius: CGFloat = 0 {
        didSet {
            rearrangeViews()
        }
    }
    @IBInspectable open dynamic var tagListViewShadowOffset: CGSize = .zero {
        didSet {
            rearrangeViews()
        }
    }
    @IBInspectable open dynamic var tagListViewShadowOpacity: Float = 0 {
        didSet {
            rearrangeViews()
        }
    }
